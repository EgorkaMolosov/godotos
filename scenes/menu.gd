...
func _on_button_2_pressed() -> void:
	GlobalInfo.multiplay = true
	GlobalInfo.parallax = parallax.get_scroll_offset()
	get_tree().change_scene_to_file("res://scenes/level_choose.tscn")# Replace with function body. # Replace with function body.
